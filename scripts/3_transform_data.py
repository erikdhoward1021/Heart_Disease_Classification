...
X_train, X_test, y_train, y_test = transform_data(data_path=male_data_path, target_column='target', population='male')
...
X_train, X_test, y_train, y_test = transform_data(data_path=female_data_path, target_column='target', population='female')
